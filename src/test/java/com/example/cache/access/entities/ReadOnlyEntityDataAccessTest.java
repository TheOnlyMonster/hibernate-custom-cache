...
@DisplayName("ReadOnlyEntityDataAccess Tests")
class ReadOnlyEntityDataAccessTest {
    ...
    void testConstructorNullEntityRegion() {
        assertThrows(IllegalArgumentException.class,
            () -> new ReadOnlyEntityDataAccess(null, domainDataRegion));
    }
    ...
    void testConstructorNullDomainDataRegion() {
        assertThrows(IllegalArgumentException.class,
            () -> new ReadOnlyEntityDataAccess(entityRegion, null));
    }
    ...
    @Test
    @DisplayName("Should return false for afterInsert")
    ...
    @Test
    @DisplayName("Should evict on afterUpdate and return false")
